 ...
 * 2. **通知8本のうち6本が5〜6群を跨ぎ、通知だけを触るメンバーは0本である
 *    ⟹「通知は構造的に孤立しているから切れる」とは言えない。** `Clone` の
 *    91フィールドをメンバーの共起で群分けした実測では、通知8本のうち5本が
 *    「5群を跨ぐ」フィールドの上位20に入り、6本目（`mergedBatchTruncation`）は
 *    6群を跨ぐ。そして**通知だけを触るメンバーは0本**（8本のうち0本が
 *    「その群しか触らないメンバー」を持つ）。**切る根拠は構造的な孤立ではなく、
