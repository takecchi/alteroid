...
- **最初の報告に「この文書を読んだか」を1行で書く — 「読んだ／作業ツリーに無かった／読んでいない」の3つから選ぶ。** 読まずに進む判断をしてもよい（急ぎの1件、この文書と無関係な作業）。**問題は、読んでいないことが依頼者から見えないことのほうである。**
  - **これは自己申告であって、機構の保証ではない。** この文書がセッションに載る条件はハーネス側が握っていて、alteroid が制御していない（「書く先を決める」）。**だから「届いたか」を測る計器が他に無い** — 3値のどれを書いたかが、いまのところ唯一の観測点である
  - **「読んだ」と書けるのは、本文を実際に読んだときだけである。** 文脈に載っていた／`cat` した／`Read` した、のどれでもよいが、**載っているはずだと思っただけのときは「読んでいない」である。** 実際に、載っていないのに載っていると思って1日ぶんの判断を組み立てた例がある
